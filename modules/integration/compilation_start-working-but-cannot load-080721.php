				...
				<div class="row row-form">
					...
					<div class="col-md-12">
						...
						<div class="row form-info-row">
							...
							//do the untar here
							echo "project_build/$productName/$buildConfigName/bc/";
							
							echo "<br><br";
							$fileNameSearch = scandir("project_build/$productName/$buildConfigName/bc");
							//echo "project_build/$productName/$buildConfigName/bc/";
							...
							foreach($fileNameSearch as $fileNameS)
							{
								...
								if(strpos($fileNameS, ".gz") !== false)
								{
									...
									echo $toExtract = "project_build/$productName/$buildConfigName/bc/".$fileNameS;
									...
									$phar = new PharData("project_build/$productName/$buildConfigName/bc/".$fileNameS);
									$phar->extractTo("project_build/$productName/$buildConfigName/bc/aa");
								...
								$fileNameSearch = scandir("project_build/$productName/$buildConfigName/bc/aa/");
								echo $folderName = $fileNameSearch[3]."-".$fileNameSearch[2];
							
							echo "<br><br>";
							echo $folderName = str_replace(".tar.gz","",$folderName);
						
							rename("project_build/$productName/$buildConfigName/bc/aa/","project_build/$productName/$buildConfigName/bc/".$folderName."/");
							...
							mkdir("project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName);
							
							copy("modules/input/files_master_file_versioning/extracted/Master File Versioning/Setup.sh","project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName."/Setup.sh");
							copy("project_build/$productName/$buildConfigName/bc/".$folderName."/install.sh","project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName."/install.sh");
							
							copy("project_build/$productName/$buildConfigName/bc/".$folderName."/".$fileNameSearch[3],"project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName."/".$fileNameSearch[3]);
							copy("project_build/$productName/$buildConfigName/bc/".$folderName."/".$fileNameSearch[2],"project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName."/".$fileNameSearch[2]);
							
							unlink("project_build/$productName/$buildConfigName/bc/".$folderName."/".$fileNameSearch[2]);
							unlink("project_build/$productName/$buildConfigName/bc/".$folderName."/".$fileNameSearch[3]);
							unlink("project_build/$productName/$buildConfigName/bc/".$folderName."/install.sh");
							
							chmod("project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName."/install.sh",0777);
							chmod("project_build/$productName/$buildConfigName/bc/".$folderName."/".$folderName."/Setup.sh",0777);
							
							echo "<br><br>Setup.sh copied to working folder...<br><br>";
						
//echo $tarfile = $folderName.".tar";
echo $tarfile= "project_build/$productName/$buildConfigName/bc/".$folderName.".tar";
//$p = new \PharData($tarfile);
	
//$tarfile = "2.5.0.0-RC1.tar";
$pd = new \PharData($tarfile);
$pd->buildFromDirectory("project_build/$productName/$buildConfigName/bc/".$folderName."/");
$pd->compress(\Phar::GZ);
