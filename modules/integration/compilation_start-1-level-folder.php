				...
				<div class="row row-form">
					...
					<div class="col-md-12">
						...
						<div class="row form-info-row">
							...
							copy("modules/input/files_master_file_versioning/extracted/Master File Versioning/Setup.sh","project_build/$productName/$buildConfigName/bc/".$folderName."/Setup.sh");
