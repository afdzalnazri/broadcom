                ...
                <p class="card-text">
				  ...
				  <div class="row row-form">
                      ...
                      <div class="form-group">
                        <label>Build Conssafig Name</label>						
						<?php 
						$editStatus = false;
						if($_GET['id']!='')
						{
...
<input type="text" disabled class="form-control"  placeholder="" value="<?php echo $buildConfigName; ?>">
					    ...
					    <input type="text" onkeyup="checkDuplicate(this.value)" class="form-control" name="buildConfigName" id="buildConfigName" placeholder="">
						<input type="hidden" value="<?php echo $id; ?>" name="idBC" id="idBC">
				 ...
				 <div class="row row-form">
					...
					<?php 
						...
						while($rowconf = mysqli_fetch_array($conf_input)){
							...
							echo '
							<div class="row">
								<div class="col-md-1"><input onclick="assCP(this.value,this.id)" class="cb" type="checkbox" id="conf_'.$rowconf['id'].'" name="configParamId[]" value="'.$rowconf['id'].'"></div>
								<div class="col-md-5">'.$rowconf['configName'].'</div>
								<div class="col-md-6"><input id="value_conf_'.$rowconf['id'].'" style="display:block-inline" type="text" class="form-control" name="configParamValue'.$rowconf['id'].'" value="'.$rowlastvalue['value'].'" hidden><br></div>
							</div>';
