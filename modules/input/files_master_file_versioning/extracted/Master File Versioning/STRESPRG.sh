...
echo ./mfgload.sh -sysop -none -no_swap -noreset -noidcheck -gen1 -fnvm $firmware_file -fmac $mac_file -mac_prof BCM57504B1KFSBG_1_Macprofile_10212020152253BC10385_6.mpf -sn4 $sn_file -vpd -log $output_file
