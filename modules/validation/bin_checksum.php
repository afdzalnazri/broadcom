...
if($_POST["boardCheckcb"]=="1"){boardChecksum($target_file_fru, $target_file_bin);}
if($_POST["productCheckcb"]=="1"){productChecksum($target_file_fru, $target_file_bin);}
if($_POST["oemStartcb"]=="1"){oemRecordChecksum($target_file_fru, $target_file_bin);}
if($_POST["oemHeadercb"]=="1"){oemHeaderChecksum($target_file_fru, $target_file_bin);}

if($_POST["boardCheckcb"]=="1"){boardChecksum($target_file_fru, $target_file_bin);}
else{boardChecksum($target_file_fru, $target_file_bin, $_POST["boardCheckSumLocStart"], $_POST["boardCheckSumLocEnd"], $_POST["boardCheckSumLocation"]);} 

if($_POST["productCheckcb"]=="1"){productChecksum($target_file_fru, $target_file_bin);}
else{productChecksum($target_file_fru, $target_file_bin, $_POST["productCheckSumLocEnd"], $_POST["productCheckSumLocEnd"], $_POST["productCheckSumLocation"]);} 

if($_POST["oemStartcb"]=="1"){oemRecordChecksum($target_file_fru, $target_file_bin);}
else{oemRecordChecksum($target_file_fru, $target_file_bin, $_POST["oemStartCheckSumLocEnd"], $_POST["oemStartCheckSumLocEnd"], $_POST["oemStartCheckSumLocation"]);} 

if($_POST["oemHeadercb"]=="1"){oemHeaderChecksum($target_file_fru, $target_file_bin);}
else{oemHeaderChecksum($target_file_fru, $target_file_bin, $_POST["oemHeaderCheckSumLocEnd"], $_POST["oemHeaderCheckSumLocEnd"], $_POST["oemHeaderCheckSumLocation"]);} 
...
{
echo $boardCheckSumLocStart;
if($_POST["boardCheckSumLocStart"]!="")
{
	
	if($_POST["boardCheckSumLocStart"]!="")boardChecksum($target_file_fru, $target_file_bin, $_POST["boardCheckSumLocStart"], $_POST["boardCheckSumLocEnd"]);
  ...
  <div class="row">
	...
	<br><br>
				...
				<div class="row">
					...
					<div class="col-md-2"><b>Default Formula</b></div>
					<div class="col-md-2"><b>Start Address (Hex)</b></div>
					<div class="col-md-2"><b>End Address (Hex)</b></div>
					<div class="col-md-2"><b>Checksum Location (Hex)</b></div>
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>Board Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="boardCheckcb" name="boardCheckcb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" name="boardCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" name="boardCheckSumLocEnd"></b></div>					
					<div class="col-md-2"><b><input type="text" name="boardCheckSumLocation"></b></div>					
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>Product Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="productCheckcb" name="productCheckcb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" name="productCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" name="productCheckSumLocEnd"></b></div>					
					<div class="col-md-2"><b><input type="text" name="productCheckSumLocation"></b></div>
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>OEM Record Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="oemStartcb" name="oemStartcb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" name="oemStartCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" name="oemStartCheckSumLocEnd"></b></div>	
					<div class="col-md-2"><b><input type="text" name="oemStartCheckSumLocation"></b></div>					
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>OEM Header Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="oemHeadercb" name="oemHeadercb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" name="oemHeaderCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" name="oemHeaderCheckSumLocEnd"></b></div>					
					<div class="col-md-2"><b><input type="text" name="oemHeaderCheckSumLocation"></b></div>					
				</div>
...
<form action="index.php?page=bin_checksum" method="post" enctype="multipart/form-data">
  ...
  Select FRU Text: <input type="file" name="fruFile" id="fruFile"><br><br>
	...
	<br><br>
				...
				<div class="row">
					<div class="col-md-2"><b>Board Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="1" name="boardCheckcb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" id="boardCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" id="boardCheckSumLocEnd"></b></div>	
					<div class="col-md-2"><b><input type="text" name="boardCheckSumLocation"></b></div>						
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>Product Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="1" name="productCheckcb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" id="productCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" id="productCheckSumLocEnd"></b></div>	
					<div class="col-md-2"><b><input type="text" name="productCheckSumLocation"></b></div>											
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>OEM Record Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="1" name="oemStartcb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" id="oemStartCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" id="oemStartCheckSumLocEnd"></b></div>					
					<div class="col-md-2"><b><input type="text" name="oemStartCheckSumLocation"></b></div>						
				</div>
				
				<div class="row">
					<div class="col-md-2"><b>OEM Header Checksum</b></div>
					<div class="col-md-2"><input type="checkbox" id="1" name="oemHeadercb" value="1" checked></div>
					<div class="col-md-2"><b><input type="text" id="oemHeaderCheckSumLocStart"></b></div>
					<div class="col-md-2"><b><input type="text" id="oemHeaderCheckSumLocEnd"></b></div>	
					<div class="col-md-2"><b><input type="text" name="oemHeaderCheckSumLocation"></b></div>						
				</div>
