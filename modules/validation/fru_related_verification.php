          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item">File Valiadtion</li>
				...
				<form onsubmit="return false" class="filter-form" id="filter_vars">  
				 <div class="row row-form">
					...
					<div class="col-md-6">
						...
						{
						?>
						<select  onchange="checkDuplicate(this.value)" id="option_product" name="option_product" onchange='read("filter_vars",<?php echo json_encode($cat_read);?>,1)' class="form-control">
							<option value="#">Select an option</option>
						...
						<?php 
							...
							?>
							<select  onchange="checkDuplicate('')" id="option_product" name="option_product" onchange='read("filter_vars",<?php echo json_encode($cat_read);?>,1)' class="form-control" disabled>
							<option value="#">Select an option</option>
						</select>
							<?php
						}
