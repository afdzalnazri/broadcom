...
//Application Title
define('APP_TITLE', 'Build Config File Manager');   
...
$root_path = $_SERVER['DOCUMENT_ROOT']."/broadcom/project_build/".$_SESSION['fileHome']."/";
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href="../?page=bc-script-editing"> Back to build config </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            echo '<div class="col-xs-6 col-sm-5"><b>' .$_SESSION['fileHome']."</b> ". $root_url . '</div>';
            ?>
